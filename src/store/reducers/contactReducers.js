...
export default function toContactReucer(state = initialState,{type, payload}) {
   ...
   switch(type){
       ...
       case ACTION_TYPES.GET_CONTACTS_ERROR: return {...state, isFetching: true, error: payload}
       //
       case ACTION_TYPES.PUT_CONTACTS_SUCCESS: return {...state, contacts: state.contacts.map((contact)=> contact.id !== payload.id ? contact : payload),
        ...
        case ACTION_TYPES.PUT_CONTACTS_ERROR: return {...state, isFetching: true, error: payload}
        //
        ...
        case ACTION_TYPES.POST_CONTACTS_ERROR: return {...state, isFetching: true, error: payload}
        //
        ...
        case ACTION_TYPES.DELETE_CONTACTS_ERROR: return {...state, isFetching: true, error: payload}
